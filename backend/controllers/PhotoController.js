...
const insertPhoto = async(req, res) => {
    ...
    // If photo was created successfully, return dta
    if(!newPhoto){
        res.status(422).json({
...
// Remove a photo form DB
 ...
 //Get user
const geUserPhotos = async(req, res) => {
    const {id} = req.params
...
const likePhoto = async (req, res) => {
    ...
    //check if user already likded the photo
